...
export const omwFromTheTub: PuzzleJson = {
  version: 1,
  format: "emoji_chain",
  source: "circle",
...
export const dailyWarmups: PuzzleJson[] = [
  {
    version: 1,
    format: "emoji_chain",
    source: "daily",
...
export const seedRevealLine = "Most people saw delay. Kevin was calmly marinating.";
export const seedShareCardText = "Kevin said omw. Kevin was still in the tub.";
